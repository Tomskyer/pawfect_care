<section>
    ...
    <div class="flex items-center mt-6 space-y-6">
        <div class="mr-2">
            @if(Auth::user()->picture)
            <img src=" {{ asset(Auth::user()->picture) }}" alt="" class="w-24 h-24 rounded-md object-cover">
            @else
            <img src="{{ url('/profile_pictures/default-user-avatar.webp') }}" alt="" class="w-24 h-24 rounded-md object-cover">
            @endif
        </div>
        <div>
