<x-app-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <h1 class="text-3xl items-center text-semibold">Edit {{ $dog->name }}'s profile</h1>
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('profile_dog.update') }}" enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="flex items-center" x-data="picturePreview()">
                    <div class="rounded-md bg-gray-200 mr-2">
                        @if($dog->picture != null)
                        <img id="preview" src="{{ asset($dog->picture) }}" alt="" class="w-24 h-24 rounded-md object-cover">
                        @else
                ...
                <div class="flex flex-row justify-between">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="birthdate" class="block mt-1 w-full" type="date" name="birthdate" :value="old('birthdate', $dog->birthdate)" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="size" class="block mt-1 w-full" type="text" name="size" :value="old('size', $dog->size)" required />
                ...
                <div class="mt-4">
                    ...
                    <x-dog-breeds-edit breed_input="{{ $dog->breed }}"></x-dog-breeds-edit>
                </div>
                ...
                <div class="mt-4 flex flex-row">
                    ...
                    <input id="neutered" class="block mt-1 rounded-md" type="checkbox" name="neutered" value="true" checked />
                    @else
                ...
                <div class="flex items-center justify-end mt-4 gap-4">
                    @if (session('status') === 'dog-profile-updated')
    ...
    @else
    <h1 class="text-3xl flex flex-col pt-6 items-center text-semibold">You do not have permission to edit this profile</h1>
    @endif
</x-app-layout>